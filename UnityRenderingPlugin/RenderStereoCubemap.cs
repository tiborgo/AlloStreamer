    ...
    void PlaneInit()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            */
            ...
            planeCeiling_4Way[i].transform.localScale = new Vector3(focal_length / 10, 1, focal_length / 10);
            ...
            planeFloor_4Way[i].transform.localScale = new Vector3(focal_length / 10, 1, focal_length / 10);
